...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="getpost.php">Navbar</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="getpost.php">Home</a>
        </li>
        <li class="nav-item">
...
if(!$conn) {
  ...
  <strong>Failure!!!</strong> sorry we are facing some issue  .
...
$sql = "INSERT INTO `form` (`sno`, `name`, `email`, `description`, `date`) VALUES (NULL, '$name', '$email', '$desc', current_timestamp())";
...
if($result)
{
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    ...
    // echo "$sql is not created succesfully". mysqli_error($conn);
